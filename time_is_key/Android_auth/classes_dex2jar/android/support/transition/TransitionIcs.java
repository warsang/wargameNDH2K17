    ...
    implements TransitionPort.TransitionListener
  {
    ...
    public void onTransitionCancel(TransitionPort paramTransitionPort)
    {
      ...
      while (localIterator.hasNext()) {
        ((TransitionInterfaceListener)localIterator.next()).onTransitionCancel(TransitionIcs.this.mExternalTransition);
      }
    }
    ...
    public void onTransitionEnd(TransitionPort paramTransitionPort)
    {
      Iterator localIterator = this.mListeners.iterator();
      while (localIterator.hasNext()) {
        ((TransitionInterfaceListener)localIterator.next()).onTransitionEnd(TransitionIcs.this.mExternalTransition);
      }
    }
    ...
    public void onTransitionPause(TransitionPort paramTransitionPort)
    {
      Iterator localIterator = this.mListeners.iterator();
      while (localIterator.hasNext()) {
        ((TransitionInterfaceListener)localIterator.next()).onTransitionPause(TransitionIcs.this.mExternalTransition);
      }
    }
    ...
    public void onTransitionResume(TransitionPort paramTransitionPort)
    {
      Iterator localIterator = this.mListeners.iterator();
      while (localIterator.hasNext()) {
        ((TransitionInterfaceListener)localIterator.next()).onTransitionResume(TransitionIcs.this.mExternalTransition);
      }
    }
    ...
    public void onTransitionStart(TransitionPort paramTransitionPort)
    {
      Iterator localIterator = this.mListeners.iterator();
      while (localIterator.hasNext()) {
        ((TransitionInterfaceListener)localIterator.next()).onTransitionStart(TransitionIcs.this.mExternalTransition);
      }
    }
