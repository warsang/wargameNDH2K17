  ...
  extends TransitionImpl
{
  ...
  {
    android.transition.TransitionValues localTransitionValues1;
    ...
    if (paramTransitionValues1 != null)
    {
      ...
      copyValues(paramTransitionValues1, localTransitionValues1);
      if (paramTransitionValues2 == null) {
        break label57;
      }
      localTransitionValues2 = new android.transition.TransitionValues();
      copyValues(paramTransitionValues2, localTransitionValues2);
    }
    for (;;)
    {
      return this.mTransition.createAnimator(paramViewGroup, localTransitionValues1, localTransitionValues2);
    ...
    implements Transition.TransitionListener
  {
    ...
    public void onTransitionCancel(Transition paramTransition)
    {
      ...
      while (localIterator.hasNext()) {
        ((TransitionInterfaceListener)localIterator.next()).onTransitionCancel(TransitionKitKat.this.mExternalTransition);
      }
    }
    ...
    public void onTransitionEnd(Transition paramTransition)
    {
      Iterator localIterator = this.mListeners.iterator();
      while (localIterator.hasNext()) {
        ((TransitionInterfaceListener)localIterator.next()).onTransitionEnd(TransitionKitKat.this.mExternalTransition);
      }
    }
    ...
    public void onTransitionPause(Transition paramTransition)
    {
      Iterator localIterator = this.mListeners.iterator();
      while (localIterator.hasNext()) {
        ((TransitionInterfaceListener)localIterator.next()).onTransitionPause(TransitionKitKat.this.mExternalTransition);
      }
    }
    ...
    public void onTransitionResume(Transition paramTransition)
    {
      Iterator localIterator = this.mListeners.iterator();
      while (localIterator.hasNext()) {
        ((TransitionInterfaceListener)localIterator.next()).onTransitionResume(TransitionKitKat.this.mExternalTransition);
      }
    }
    ...
    public void onTransitionStart(Transition paramTransition)
    {
      Iterator localIterator = this.mListeners.iterator();
      while (localIterator.hasNext()) {
        ((TransitionInterfaceListener)localIterator.next()).onTransitionStart(TransitionKitKat.this.mExternalTransition);
      }
    }
